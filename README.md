...
3. Обогатить входные данные информацией о стране и городе, с которой пользователь отметился (по IP)
4. Создать простую [single page application](https://en.wikipedia.org/wiki/Single-page_application), выводящую все записи из базы в табличном виде и позволяющие фильтровать по имени пользователя, городу и флагу активности.
...
Результатом вашей работы будет архитектурная диаграмма, а вопросы ниже помогут вам нарисовать ее:
